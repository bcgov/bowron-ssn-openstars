...
This project builds on [bowron-ssn](https://github.com/bcgov/bowron-ssn) and seeks to be a fully open source implementation.

### openSTARS and SSN 

This repository is preliminary R language workflow to model stream temperatures using [openSTARS](https://github.com/MiKatt/openSTARS) (an open source implementation of [STARS](https://www.fs.fed.us/rm/boise/AWAE/projects/SSN_STARS/software_data.html)) and [ssn](https://cran.r-project.org/web/packages/SSN/index.html). 
...
```{r, out.width='85%', fig.align='center', fig.cap='...'}
knitr::include_graphics('git_img/field.png')
```
...
knitr::include_graphics('git_img/preds.png')
```
